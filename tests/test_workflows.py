...
class WorkflowTests(unittest.TestCase):
    ...
    def test_recommended_workflows_are_hf_only_identity_variants(self):
        recommended = [
        ...
        for name in recommended:
            ...
            self.assertIn(
                [
                    "ltx23/LTX2.3_reasoning_I2V_V3.safetensors",
                    1,
                ],
                lora_values,
            )
            self.assertIn(
                [
                    "ltx23/ltx23_edit_anything_global_rank128_v1_9000steps_adamw.safetensors",
                    0.35,
                ],
                lora_values,
            )
